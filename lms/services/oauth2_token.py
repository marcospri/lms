...
from lms.db import LockType, try_advisory_txn_lock
...
class OAuth2TokenService:
    ...
    def try_lock_for_refresh(self, service=Service.LMS) -> bool:
        """
        ...
        return try_advisory_txn_lock(self._db, LockType.OAUTH2_TOKEN_REFRESH, token.id)
